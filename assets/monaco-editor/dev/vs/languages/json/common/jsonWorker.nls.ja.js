...
define("vs/languages/json/common/jsonWorker.nls.ja", {
	"vs/base/common/http": [
	...
	"vs/languages/json/common/contributions/bowerJSONContribution": [
		"既定の bower.json",
		"bower レジストリに対する要求が失敗しました: {0}",
		"bower レジストリに対する要求が失敗しました: {0}",
		"{0}",
	],
	"vs/languages/json/common/contributions/globPatternContribution": [
		"特定の拡張子のファイル",
		"特定のファイル拡張子を持つすべてのファイルと一致します。",
		"複数の拡張子のファイル",
		"いずれかのファイル拡張子を持つすべてのファイルと一致します。",
		"同じ名前の兄弟があるファイル",
		"名前が同じで拡張子が異なる兄弟を持つファイルと一致します。",
		"特定の名前のフォルダー (最上位)",
		"特定の名前の最上位にあるフォルダーと一致します。",
		"複数の名前のフォルダー (最上位)",
		"複数の最上位フォルダーと一致します。",
		"特定の名前のフォルダー (任意の場所)",
		"任意の場所にある特定の名前のフォルダーと一致します。",
		"True",
		"パターンを有効にします。",
		"False",
		"パターンを無効にします。",
	...
	"vs/languages/json/common/contributions/packageJSONContribution": [
		"既定の package.json",
		"NPM リポジトリに対する要求が失敗しました: {0}",
		"NPM リポジトリに対する要求が失敗しました: {0}",
		"パッケージの現在の最新バージョン",
		"最新のメジャー バージョンと一致します (1.x.x)",
		"最新のマイナー バージョンと一致します (1.2.x)",
		"{0}",
		"最新バージョン: {0}",
	],
	"vs/languages/json/common/contributions/projectJSONContribution": [
		"既定の project.json",
		"nuget リポジトリに対する要求が失敗しました: {0}",
		"nuget リポジトリに対する要求が失敗しました: {0}",
		"パッケージの現在の最新バージョン",
		"{0}",
		"最新バージョン: {0}",
	...
	"vs/languages/json/common/jsonSchemaService": [
		...
		"\'{0}\' からスキーマを読み込むことができません: {1}。",
		"$ref \'{0}\' in {1} can not be resolved.",
		"Problems loading reference \'{0}\': {1}",
	],
	"vs/languages/json/common/parser/jsonParser": [
		"型が正しくありません。{0} のいずれかが必要です",
		"型が正しくありません。\"{0}\" が必要です",
		"許可されていないスキーマと一致します。",
		"1 つだけ検証する必要があるときに複数のスキーマと一致します。",
		"値が利用可能な値ではありません。有効な値: {0}",
		"スキーマに従って配列に含まれる項目が多すぎます。{0} 個以下にする必要があります。",
		"配列の項目が少なすぎます。{0} 個以上にする必要があります",
		"配列の項目が多すぎます。{0} 個以下にする必要があります",
		"配列に重複する項目が含まれています",
		"値は {0} で割り切ることができません",
		"値が排他の最小値 {0} を下回っています",
		"値が最小値 {0} を下回っています",
		...
		"プロパティ \"{0}\" がありません",
		"プロパティ {0} は許可されていません",
		"オブジェクトには、{0} 個の制限を超えるプロパティが含まれています",
		"オブジェクトに含まれるプロパティの数が必要な数 {0} 個を下回っています",
		"プロパティ {1} に必要なプロパティ {0} がオブジェクトにありません",
		"文字列に無効な Unicode シーケンスがあります",
		"文字列に無効なエスケープ文字があります",
		"予期しない数の終了",
		"予期しないコメントの終了",
		"予期しない文字列の終了",
